...
RUN mkdir /mitoz_tmp && cd /mitoz_tmp && wget -c https://raw.githubusercontent.com/linzhi2013/MitoZ/master/version_1.0/release_MitoZ_v1.0.tar.bz2 &&  tar -jxvf release_MitoZ_v1.0.tar.bz2  && mv release_MitoZ_v1.0 /app && rm -rf /mitoz_tmp
...
# ENTRYPOINT ["/app/anaconda/bin/python3 /app/release_MitoZ_v1.0/MitoZ.py"]
CMD ["/bin/bash"]
