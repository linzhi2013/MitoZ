...
**News**
- I found that using too much raw data (e.g. 12 Gbp) can lead to an un-circular mitogenome while using less raw data (e.g., 0.3 Gbp) can obtain a circular mitogenome (`mitoz all --assembler megahit --kmers_megahit  43 71 99`). So please try a smaller dataset first and it is also less computationally intensive (8 CPUs, max RAM: 2GB, total run time: 10 mins) and faster!
