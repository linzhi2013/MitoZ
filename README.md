...
- **(April-19-2023) On the installation problem (https://github.com/linzhi2013/MitoZ/issues/188), hopefully now it is fixed. Please let me know if it is not. You might need to specify the Python versions (>=3.6,<3.9) if you have the same problem when install conda from source code or conda. This is because my rebuild version of mitoz on Bioconda has [not been merged](https://github.com/bioconda/bioconda-recipes/pull/40510)**
