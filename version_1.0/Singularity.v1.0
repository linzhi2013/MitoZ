...
%post
    ...
    mkdir /mitoz_tmp && cd /mitoz_tmp && wget  https://raw.githubusercontent.com/linzhi2013/MitoZ/master/release_MitoZ_v1.0.tar.bz2 &&  tar -jxvf release_MitoZ_v1.0.tar.bz2  && mv release_MitoZ_v1.0 /app
    rm -rf /mitoz_tmp
