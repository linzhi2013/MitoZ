...
RUN mkdir /mitoz_tmp && cd /mitoz_tmp && wget -c https://raw.githubusercontent.com/linzhi2013/MitoZ/master/version_2.2/release_MitoZ_v2.2.tar.bz2 &&  tar -jxvf release_MitoZ_v2.2.tar.bz2  && mv release_MitoZ_v2.2 /app && rm -rf /mitoz_tmp
