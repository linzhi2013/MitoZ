...
**News**
- **MitoZ 3.4 has come out (and rebuilt for the Conda version too) and fixed a few bugs, it's recommended to update to this version!**: `mamba create -n mitozEnv -c bioconda mitoz=3.4=pypl5321hdfd78af_1`
